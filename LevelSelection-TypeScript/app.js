...
(function (LevelSelectProject) {
    var Game = (function (_super) {
        ...
        function Game() {
            ...
            this.state.add('DragSelection', LevelSelectProject.DragSelection);
            this.state.add('DragSelection2', LevelSelectProject.DragSelection2);
...
var LevelSelectProject;
(function (LevelSelectProject) {
    var DragSelection2 = (function (_super) {
        __extends(DragSelection2, _super);
        function DragSelection2() {
            _super.apply(this, arguments);
            this.colors = [
        ...
        DragSelection2.prototype.init = function () {
            console.log((new Date).toISOString() + ' : Entered DragSelection2 init()');
            // init can receive parameters.
        };
        DragSelection2.prototype.preload = function () {
        ...
        DragSelection2.prototype.create = function () {
            ...
            for (var p = 0; p < this.colors.length; p++) {
                ...
                this.pageSelectors[p] = this.game.add.button(this.game.width / 2 + (p - Math.floor(this.colors.length / 2) + 0.5 * (1 - this.colors.length % 2)) * 40, this.game.height - 30, "levelpages", function (e) {
        ...
        DragSelection2.prototype.changePage = function (page) {
    ...
    LevelSelectProject.DragSelection2 = DragSelection2;
})(LevelSelectProject || (LevelSelectProject = {}));
var LevelSelectProject;
(function (LevelSelectProject) {
